...
@OriginatingElement(
    topLevelClass = EmailConfirmationViewModel.class
)
public final class EmailConfirmationViewModel_HiltModules {
  ...
  public abstract static class BindsModule {
    ...
    @Binds
    @IntoMap
    @LazyClassKey(EmailConfirmationViewModel.class)
    @HiltViewModelMap
    public abstract ViewModel binds(EmailConfirmationViewModel vm);
  }
